...
class VideoAPITestCasse:
    ...
    def test_video_list_post(self):
        ...
        data = {
            ...
            "video_file": SimpleUploadedFile("file.mp4", b"file_content", "video/mpt"),
            "user": self.user.pk,
        }
